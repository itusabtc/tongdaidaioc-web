...
export default function AccountPage() {
  ...
  const tabs = [
    { id: 'listings', label: 'Tin đã đăng', count: 2 },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-1">
                {[
                  { icon: '📋', label: 'Thông tin cá nhân', href: '/tai-khoan/thong-tin' },
                  { icon: '🔒', label: 'Bảo mật', href: '/tai-khoan/bao-mat' },
                  { icon: '📧', label: 'Cài đặt email', href: '/tai-khoan/email' },
                  { icon: '📱', label: 'Cài đặt thông báo', href: '/tai-khoan/thong-bao' },
