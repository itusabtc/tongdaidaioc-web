...
export default async function RentPage({ searchParams }: Props) {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* Hero Banner */}
      <HeroBanner
        title="Cho thuê nhà đất TP.HCM"
        subtitle="Tìm kiếm hàng nghìn tin đăng cho thuê từ chủ nhà và môi giới — Đăng tin miễn phí, AI hỗ trợ"
        backgroundImage="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=1200&h=500&fit=crop"
        height="medium"
        cta={{
          label: 'Đăng tin cho thuê ngay',
