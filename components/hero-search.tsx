...
export default function HeroSearch() {
  ...
  const [filters, setFilters] = useState<QuickFilter[]>([
    { id: '1', label: 'The Global City' },
    { id: '2', label: 'Caraworld Cam Ranh' },
    { id: '3', label: 'Eaton Park' },
    { id: '4', label: 'LUMIÈRE Boulevard' },
  ]);
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 z-20 hidden lg:flex items-center justify-center">
        <div className="bg-gray-800/80 text-white px-4 py-12 writing-mode-vertical transform -rotate-90">
          <span className="text-sm font-semibold whitespace-nowrap">Nhập các đất</span>
        </div>
      </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="bg-white rounded-md shadow-2xl p-0 overflow-hidden mb-6">
            ...
            <div className="flex items-center">
              ...
              <button className="px-6 md:px-8 py-4 bg-red-600 text-white font-bold hover:bg-red-700 transition whitespace-nowrap text-sm md:text-base">
                Tìm kiếm
              </button>
            </div>
          </div>
          ...
          <div>
            <p className="text-white text-sm mb-3">
              Hiện có <span className="font-bold">177,207</span> nhà đất xác thực
            </p>
