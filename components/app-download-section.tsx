        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg mb-8">
              Cài đặt ứng dụng TDDO trên thiết bị di động để trải nghiệm trọn vẹn:
            </p>

            <ul className="space-y-4 mb-10">
              <li className="flex items-start gap-3">
                <span className="inline-block w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0" />
              ...
              <li className="flex items-start gap-3">
                <span className="inline-block w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0" />
                <span className="text-gray-700">
                  Xem đầy đủ thông tin bất động sán trên nền tảng
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="inline-block w-1.5 h-1.5 bg-accent rounded-full mt-2 flex-shrink-0" />
